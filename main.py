#  -- P4Weather -- 
# Simple Pygame Weather App
# Final version  v1.0.2
# -> Added logging to weather.py
...
# Global variables
BG_COLOUR: tuple = (62, 69, 81)
BLACK: tuple = (0, 0, 0)
CITY = weather.get_city()
SELECTED_DAY: int = 0
clock = pygame.time.Clock()
init_box_y_upper: float = 525/2
init_box_y_lower: float = 525/2
...
def increment_time(day: int, month: int, change: int) -> tuple:
    local_day = day
    local_month = month
    local_change = change
...
def increment_day_of_week(day_of_the_week: str, change: int) -> str:
    ...
    weekdays: list = ["Sun", "Mon", "Tue", "Wed", "Thr", "Fri", "Sat", "Sun"]
    pos_in_arr: int = 0
...
#53d267dc65c820ee69e868404282336a208a6ec672f270e869de1a